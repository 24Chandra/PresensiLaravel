            ...
            <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <a href="{{url('role/edit/'.$d->Nis)}}" class="btn btn-info btn-xs waves-effect waves-light"><i class="fa fa-edit"></i> Edit</a>
                      <?php } ?>
                      <?php
                      if($d->Nis != 1){
                      if($all_access->where('name','Role-Delete')->count() > 0){ ?>
                      <a href="<?= url('role/delete/'.$d->Nis);?>" class="btn btn-danger btn-xs waves-effect waves-light"><i class="fa fa-trash"></i> Delete</a>
                      <?php } } ?>
                      </td>
                    </tr>
                    <?php endforeach;?>
